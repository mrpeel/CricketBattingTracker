# 34-Channel Polar Self-Referential Temporal Dynamics Experiment Scorecard Report (Option B)

**Experiment**: Option B (34 Channels: 28 Baseline Channels including 3D Vectors + 6 Rotation-Invariant Polar Self-Temporal Channels)  
**Polar Channels Added**: `p_gyro_mag`, `p_acc_mag`, `p_gyro_d25ms`, `p_gyro_d100ms`, `p_acc_d25ms`, `p_rel_surge` (Appended to baseline `p_acc_x,y,z` and `p_gyro_x,y,z`)  
**Architecture**: Hierarchical Multi-Tier Stance-Gated TCN Pipeline (Stage 1 Facing Up Stance Detector + Stage 2 Bat-Plane 3-Family Multi-Scale TCN, `in_ch=34`)  
...
**Holdout Macro-F1 Checkpointing**: Best Epoch 24 (Best Macro-F1: 0.6325, Candidate Acc: 65.05%, Val Loss: 1.0607, Stopped at Epoch 35)  
**Execution Log File**: `/Users/neilkloot/Code/CricketBattingTracker/pipelines/training_logs/polar_option_b_experiment_2026-09-04_21-30-30.log`  
...
|---|:---:|:---:|:---:|:---:|:---:|:---:|
| **PULL/HOOK/SLOG** | 57 | 49 | 86.0% | 28 | **57.1%** | **49.1%** |
| **DRIVE/DEFENCE** | 30 | 27 | 90.0% | 18 | **66.7%** | **60.0%** |
| **GLANCE/FLICK** | 27 | 22 | 81.5% | 14 | **63.6%** | **51.9%** |
| **CUT/PUNCH** | 13 | 11 | 84.6% | 8 | **72.7%** | **61.5%** |
| **DEFLECTION/GUIDE** | 28 | 21 | 75.0% | 21 | **100.0%** | **75.0%** |
| **POWER DRIVE** | 20 | 20 | 100.0% | 6 | **30.0%** | **30.0%** |
| **SWEEP** | 31 | 30 | 96.8% | 29 | **96.7%** | **93.5%** |
| **OVERALL TOTAL** | **206** | **180** | **87.4%** | **124** | 🏆 **68.9%** | 🏆 **60.2%** |

### 🏋️ Training Set Per-Shot Accuracy Breakdown (63 Sessions)
| Shot Class | Physical GT Shots | Shots Detected | **Detection Recall (%)** | **Correctly Classified Shots** | **Classification Accuracy (%)** | **Total Coverage Rate (%)** |
|---|:---:|:---:|:---:|:---:|:---:|:---:|
| **PULL/HOOK/SLOG** | 994 | 787 | 79.2% | 785 | **99.7%** | **79.0%** |
| **DRIVE/DEFENCE** | 914 | 731 | 80.0% | 730 | **99.9%** | **79.9%** |
| **GLANCE/FLICK** | 612 | 485 | 79.2% | 477 | **98.4%** | **77.9%** |
| **CUT/PUNCH** | 372 | 327 | 87.9% | 325 | **99.4%** | **87.4%** |
| **DEFLECTION/GUIDE** | 220 | 172 | 78.2% | 170 | **98.8%** | **77.3%** |
| **POWER DRIVE** | 256 | 190 | 74.2% | 188 | **98.9%** | **73.4%** |
| **SWEEP** | 212 | 181 | 85.4% | 177 | **97.8%** | **83.5%** |
| **OVERALL TOTAL** | **3580** | **2873** | **80.3%** | **2852** | 🏆 **99.3%** | 🏆 **79.7%** |

### 🏆 Full Dataset Per-Shot Accuracy Breakdown (All 67 Sessions)
| Shot Class | Physical GT Shots | Shots Detected | **Detection Recall (%)** | **Correctly Classified Shots** | **Classification Accuracy (%)** | **Total Coverage Rate (%)** |
|---|:---:|:---:|:---:|:---:|:---:|:---:|
| **PULL/HOOK/SLOG** | 1051 | 836 | 79.5% | 813 | **97.2%** | **77.4%** |
| **DRIVE/DEFENCE** | 944 | 758 | 80.3% | 748 | **98.7%** | **79.2%** |
| **GLANCE/FLICK** | 639 | 507 | 79.3% | 491 | **96.8%** | **76.8%** |
| **CUT/PUNCH** | 385 | 338 | 87.8% | 333 | **98.5%** | **86.5%** |
| **DEFLECTION/GUIDE** | 248 | 193 | 77.8% | 191 | **99.0%** | **77.0%** |
| **POWER DRIVE** | 276 | 210 | 76.1% | 194 | **92.4%** | **70.3%** |
| **SWEEP** | 243 | 211 | 86.8% | 206 | **97.6%** | **84.8%** |
| **OVERALL TOTAL** | **3786** | **3053** | **80.6%** | **2976** | 🏆 **97.5%** | 🏆 **78.6%** |
...
| **VERTICAL_BAT_CONFUSION** | **20** | PULL/HOOK/SLOG (19), CUT/PUNCH (1) |
| **SWEEP_CONFUSION** | **13** | GLANCE/FLICK (3), CUT/PUNCH (3), POWER DRIVE (3) |
| **CROSS_BAT_CONFUSION (Macro Gate)** | **10** | POWER DRIVE (10) |
| **SUBCLASS_CONFUSION** | **7** | GLANCE/FLICK (4), DRIVE/DEFENCE (2), POWER DRIVE (1) |
| **CROSS_BAT_CONFUSION** | **7** | DRIVE/DEFENCE (6), GLANCE/FLICK (1) |
...
|---|:---:|:---:|:---:|:---:|:---:|:---:|:---:|---|
| `session_2026-07-20_12-42-16` | 106.04 | **GLANCE/FLICK** | SWEEP | `SWEEP_CONFUSION` | 0.95 | 106.04 | +0.00 | *flip shot okay* |
| `session_2026-07-20_12-42-16` | 173.89 | **SWEEP** | PULL/HOOK/SLOG | `SWEEP_CONFUSION` | 0.35 | 173.89 | +0.00 | *sweep shot good* |
...
| `session_2026-07-20_12-42-16` | 429.95 | **GLANCE/FLICK** | SWEEP | `SWEEP_CONFUSION` | 0.90 | 429.95 | +0.00 | *flip shot edge* |
| `session_2026-07-20_12-42-16` | 459.47 | **GLANCE/FLICK** | SWEEP | `SWEEP_CONFUSION` | 0.79 | 459.47 | +0.00 | *flip shot okay* |
| `session_2026-07-20_12-42-16` | 557.88 | **DRIVE/DEFENCE** | SWEEP | `SWEEP_CONFUSION` | 0.94 | 557.88 | +0.00 | *straight shot good end of round* |
...
| `session_2026-07-21_12-43-37` | 173.32 | **DRIVE/DEFENCE** | GLANCE/FLICK | `SUBCLASS_CONFUSION` | 0.86 | 173.32 | +0.00 | *oh back defense okay* |
| `session_2026-07-21_12-43-37` | 199.60 | **PULL/HOOK/SLOG** | GLANCE/FLICK | `VERTICAL_BAT_CONFUSION` | 0.86 | 199.60 | +0.00 | *foot shot good facing up* |
| `session_2026-07-21_12-43-37` | 207.58 | **PULL/HOOK/SLOG** | GLANCE/FLICK | `VERTICAL_BAT_CONFUSION` | 0.86 | 207.58 | +0.00 | *foot shot good* |
| `session_2026-07-21_12-43-37` | 517.26 | **PULL/HOOK/SLOG** | GLANCE/FLICK | `VERTICAL_BAT_CONFUSION` | 0.79 | 517.26 | +0.00 | *foot shot okay* |
| `session_2026-07-21_12-43-37` | 524.97 | **PULL/HOOK/SLOG** | GLANCE/FLICK | `VERTICAL_BAT_CONFUSION` | 0.86 | 524.98 | +0.00 | *foot shot good* |
| `session_2026-07-21_12-43-37` | 572.76 | **PULL/HOOK/SLOG** | GLANCE/FLICK | `VERTICAL_BAT_CONFUSION` | 0.60 | 572.76 | +0.00 | *foot shot good* |
| `session_2026-07-21_12-43-37` | 581.22 | **PULL/HOOK/SLOG** | DRIVE/DEFENCE | `VERTICAL_BAT_CONFUSION` | 0.84 | 579.83 | -1.39 | *foot shot good facing up* |
| `session_2026-07-21_12-43-37` | 595.90 | **GLANCE/FLICK** | DRIVE/DEFENCE | `SUBCLASS_CONFUSION` | 0.77 | 595.90 | +0.00 | *uh-huh flick shot okay* |
| `session_2026-07-21_12-43-37` | 617.47 | **PULL/HOOK/SLOG** | GLANCE/FLICK | `VERTICAL_BAT_CONFUSION` | 0.85 | 616.70 | -0.77 | *hook shot good facing up* |
...
| `session_2026-07-21_12-43-37` | 933.45 | **DRIVE/DEFENCE** | GLANCE/FLICK | `SUBCLASS_CONFUSION` | 0.61 | 933.45 | +0.00 | *on drive good* |
| `session_2026-07-21_12-43-37` | 955.27 | **GLANCE/FLICK** | DRIVE/DEFENCE | `SUBCLASS_CONFUSION` | 0.85 | 955.27 | +0.00 | *flip shot good* |
| `session_2026-07-21_12-43-37` | 967.40 | **GLANCE/FLICK** | ⚠️ NONE | `NOT_DETECTED (MISSING_CANDIDATE)` | 0.00 | 965.01 | -2.40 | *switch up for* |
| `session_2026-07-21_12-43-37` | 978.28 | **PULL/HOOK/SLOG** | GLANCE/FLICK | `VERTICAL_BAT_CONFUSION` | 0.87 | 978.28 | +0.00 | *foot shot good* |
| `session_2026-07-21_12-43-37` | 983.21 | **PULL/HOOK/SLOG** | DRIVE/DEFENCE | `VERTICAL_BAT_CONFUSION` | 0.85 | 983.22 | +0.00 | *foot shot good* |
...
| `session_2026-07-24_12-52-29` | 132.76 | **DRIVE/DEFENCE** | CUT/PUNCH | `CROSS_BAT_CONFUSION` | 0.91 | 132.76 | +0.00 | *back foot punch four* |
...
| `session_2026-07-24_12-52-29` | 521.41 | **DRIVE/DEFENCE** | CUT/PUNCH | `CROSS_BAT_CONFUSION` | 0.91 | 520.20 | -1.21 | *back foot punch okay facing up* |
...
| `session_2026-07-24_12-52-29` | 538.05 | **DRIVE/DEFENCE** | CUT/PUNCH | `CROSS_BAT_CONFUSION` | 0.56 | 537.07 | -0.98 | *k foot punch okay facing up* |
...
| `session_2026-07-24_12-52-29` | 584.08 | **CUT/PUNCH** | SWEEP | `SWEEP_CONFUSION` | 0.47 | 584.08 | +0.00 | *touch shot good facing up* |
| `session_2026-07-24_12-52-29` | 909.03 | **CUT/PUNCH** | SWEEP | `SWEEP_CONFUSION` | 0.58 | 908.67 | -0.36 | *cut shot good* |
| `session_2026-07-24_12-52-29` | 935.85 | **DRIVE/DEFENCE** | CUT/PUNCH | `CROSS_BAT_CONFUSION` | 0.58 | 935.20 | -0.64 | *back foot punch okay facing up* |
| `session_2026-07-24_12-52-29` | 1027.62 | **CUT/PUNCH** | SWEEP | `SWEEP_CONFUSION` | 0.67 | 1027.62 | +0.00 | *touch shot okay* |
| `session_2026-07-25_15-16-32` | 82.82 | **PULL/HOOK/SLOG** | POWER DRIVE | `VERTICAL_BAT_CONFUSION` | 0.58 | 82.82 | +0.00 | *slog okay* |
| `session_2026-07-25_15-16-32` | 98.78 | **PULL/HOOK/SLOG** | SWEEP | `SWEEP_CONFUSION` | 0.40 | 98.78 | +0.00 | *pull shot okay* |
| `session_2026-07-25_15-16-32` | 109.58 | **PULL/HOOK/SLOG** | POWER DRIVE | `VERTICAL_BAT_CONFUSION` | 0.54 | 109.58 | +0.00 | *slog good* |
| `session_2026-07-25_15-16-32` | 119.11 | **PULL/HOOK/SLOG** | POWER DRIVE | `VERTICAL_BAT_CONFUSION` | 0.83 | 119.11 | +0.00 | *slog edge* |
| `session_2026-07-25_15-16-32` | 126.16 | **PULL/HOOK/SLOG** | POWER DRIVE | `VERTICAL_BAT_CONFUSION` | 0.90 | 126.16 | +0.00 | *slog okay* |
| `session_2026-07-25_15-16-32` | 134.36 | **POWER DRIVE** | PULL/HOOK/SLOG | `CROSS_BAT_CONFUSION (Macro Gate)` | 0.84 | 134.36 | +0.00 | *power drive good* |
| `session_2026-07-25_15-16-32` | 158.84 | **PULL/HOOK/SLOG** | POWER DRIVE | `VERTICAL_BAT_CONFUSION` | 0.47 | 158.84 | +0.00 | *slog edge* |
| `session_2026-07-25_15-16-32` | 186.74 | **POWER DRIVE** | PULL/HOOK/SLOG | `CROSS_BAT_CONFUSION (Macro Gate)` | 0.89 | 186.74 | +0.00 | *power drive okay* |
| `session_2026-07-25_15-16-32` | 203.06 | **POWER DRIVE** | PULL/HOOK/SLOG | `CROSS_BAT_CONFUSION (Macro Gate)` | 0.72 | 203.06 | +0.00 | *power drive okay* |
| `session_2026-07-25_15-16-32` | 211.69 | **PULL/HOOK/SLOG** | SWEEP | `SWEEP_CONFUSION` | 0.92 | 211.69 | +0.00 | *slog good* |
| `session_2026-07-25_15-16-32` | 226.76 | **POWER DRIVE** | PULL/HOOK/SLOG | `CROSS_BAT_CONFUSION (Macro Gate)` | 0.88 | 226.76 | +0.00 | *power drive okay* |
...
| `session_2026-07-25_15-16-32` | 735.36 | **POWER DRIVE** | PULL/HOOK/SLOG | `CROSS_BAT_CONFUSION (Macro Gate)` | 0.46 | 735.37 | +0.00 | *power drive 4* |
| `session_2026-07-25_15-16-32` | 751.12 | **POWER DRIVE** | PULL/HOOK/SLOG | `CROSS_BAT_CONFUSION (Macro Gate)` | 0.87 | 751.12 | +0.00 | *power drive okay* |
| `session_2026-07-25_15-16-32` | 768.77 | **POWER DRIVE** | SWEEP | `SWEEP_CONFUSION` | 0.48 | 768.77 | +0.00 | *power drive good* |
| `session_2026-07-25_15-16-32` | 782.31 | **POWER DRIVE** | SWEEP | `SWEEP_CONFUSION` | 0.96 | 782.31 | +0.00 | *power drive pull* |
| `session_2026-07-25_15-16-32` | 835.20 | **POWER DRIVE** | PULL/HOOK/SLOG | `CROSS_BAT_CONFUSION (Macro Gate)` | 0.89 | 835.20 | +0.00 | *power drive okay* |
| `session_2026-07-25_15-16-32` | 1043.07 | **POWER DRIVE** | PULL/HOOK/SLOG | `CROSS_BAT_CONFUSION (Macro Gate)` | 0.88 | 1043.07 | +0.00 | *power drive okay facing up* |
| `session_2026-07-25_15-16-32` | 1052.24 | **GLANCE/FLICK** | PULL/HOOK/SLOG | `CROSS_BAT_CONFUSION` | 0.89 | 1052.24 | +0.00 | *flick shot okay* |
| `session_2026-07-25_15-16-32` | 1061.78 | **PULL/HOOK/SLOG** | POWER DRIVE | `VERTICAL_BAT_CONFUSION` | 0.35 | 1061.78 | +0.00 | *slog okay facing up* |
| `session_2026-07-25_15-16-32` | 1069.06 | **PULL/HOOK/SLOG** | POWER DRIVE | `VERTICAL_BAT_CONFUSION` | 0.40 | 1069.06 | +0.00 | *slog* |
| `session_2026-07-25_15-16-32` | 1078.21 | **PULL/HOOK/SLOG** | POWER DRIVE | `VERTICAL_BAT_CONFUSION` | 0.47 | 1078.21 | +0.00 | *pull shot okay* |
| `session_2026-07-25_15-16-32` | 1101.77 | **GLANCE/FLICK** | POWER DRIVE | `SUBCLASS_CONFUSION` | 0.49 | 1101.77 | +0.00 | *flick shot good* |
| `session_2026-07-25_15-16-32` | 1109.60 | **PULL/HOOK/SLOG** | DRIVE/DEFENCE | `VERTICAL_BAT_CONFUSION` | 0.26 | 1109.60 | +0.00 | *slog good* |
| `session_2026-07-25_15-16-32` | 1137.55 | **POWER DRIVE** | SWEEP | `SWEEP_CONFUSION` | 0.61 | 1137.56 | +0.00 | *power drive terrible four facing up* |
| `session_2026-07-25_15-16-32` | 1179.12 | **PULL/HOOK/SLOG** | POWER DRIVE | `VERTICAL_BAT_CONFUSION` | 0.90 | 1179.12 | +0.00 | *slog good* |
| `session_2026-07-25_15-16-32` | 1201.60 | **POWER DRIVE** | GLANCE/FLICK | `SUBCLASS_CONFUSION` | 0.39 | 1201.60 | +0.00 | *power drive terrible facing up* |
| `session_2026-07-25_15-16-32` | 1212.40 | **POWER DRIVE** | PULL/HOOK/SLOG | `CROSS_BAT_CONFUSION (Macro Gate)` | 0.86 | 1212.40 | +0.00 | *power drive good* |
