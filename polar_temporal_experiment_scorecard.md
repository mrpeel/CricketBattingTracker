# 28-Channel Polar Self-Referential Temporal Dynamics Experiment Scorecard Report (Option A)

**Experiment**: Option A (28 Channels: 19 Watch Earth-Aligned + 6 Rotation-Invariant Polar Self-Temporal + 3 Metadata)  
**Polar Channels**: `p_gyro_mag`, `p_acc_mag`, `p_gyro_d25ms`, `p_gyro_d100ms`, `p_acc_d25ms`, `p_rel_surge` (Purging raw unaligned `p_acc_x,y,z` and `p_gyro_x,y,z`)  
**Architecture**: Hierarchical Multi-Tier Stance-Gated TCN Pipeline (Stage 1 Facing Up Stance Detector + Stage 2 Bat-Plane 3-Family Multi-Scale TCN, `in_ch=28`)  
...
**Holdout Macro-F1 Checkpointing**: Best Epoch 7 (Best Macro-F1: 0.6412, Candidate Acc: 63.59%, Val Loss: 0.8715, Stopped at Epoch 25)  
**Execution Log File**: `/Users/neilkloot/Code/CricketBattingTracker/pipelines/training_logs/polar_temporal_experiment_2026-09-04_19-39-15.log`  
**Date**: 2026-09-04 21:24
...
| **DRIVE/DEFENCE** | 30 | 27 | 90.0% | 20 | **74.1%** | **66.7%** |
| **GLANCE/FLICK** | 27 | 22 | 81.5% | 14 | **63.6%** | **51.9%** |
| **CUT/PUNCH** | 13 | 11 | 84.6% | 8 | **72.7%** | **61.5%** |
| **DEFLECTION/GUIDE** | 28 | 21 | 75.0% | 20 | **95.2%** | **71.4%** |
| **POWER DRIVE** | 20 | 20 | 100.0% | 9 | **45.0%** | **45.0%** |
| **SWEEP** | 31 | 30 | 96.8% | 29 | **96.7%** | **93.5%** |
| **OVERALL TOTAL** | **206** | **180** | **87.4%** | **122** | 🏆 **67.8%** | 🏆 **59.2%** |

### 🏋️ Training Set Per-Shot Accuracy Breakdown (63 Sessions)
| Shot Class | Physical GT Shots | Shots Detected | **Detection Recall (%)** | **Correctly Classified Shots** | **Classification Accuracy (%)** | **Total Coverage Rate (%)** |
|---|:---:|:---:|:---:|:---:|:---:|:---:|
| **PULL/HOOK/SLOG** | 994 | 787 | 79.2% | 694 | **88.2%** | **69.8%** |
| **DRIVE/DEFENCE** | 914 | 731 | 80.0% | 690 | **94.4%** | **75.5%** |
| **GLANCE/FLICK** | 612 | 485 | 79.2% | 421 | **86.8%** | **68.8%** |
| **CUT/PUNCH** | 372 | 327 | 87.9% | 305 | **93.3%** | **82.0%** |
| **DEFLECTION/GUIDE** | 220 | 172 | 78.2% | 167 | **97.1%** | **75.9%** |
| **POWER DRIVE** | 256 | 190 | 74.2% | 186 | **97.9%** | **72.7%** |
| **SWEEP** | 212 | 181 | 85.4% | 171 | **94.5%** | **80.7%** |
| **OVERALL TOTAL** | **3580** | **2873** | **80.3%** | **2634** | 🏆 **91.7%** | 🏆 **73.6%** |

### 🏆 Full Dataset Per-Shot Accuracy Breakdown (All 67 Sessions)
| Shot Class | Physical GT Shots | Shots Detected | **Detection Recall (%)** | **Correctly Classified Shots** | **Classification Accuracy (%)** | **Total Coverage Rate (%)** |
|---|:---:|:---:|:---:|:---:|:---:|:---:|
| **PULL/HOOK/SLOG** | 1051 | 836 | 79.5% | 716 | **85.6%** | **68.1%** |
| **DRIVE/DEFENCE** | 944 | 758 | 80.3% | 710 | **93.7%** | **75.2%** |
| **GLANCE/FLICK** | 639 | 507 | 79.3% | 435 | **85.8%** | **68.1%** |
| **CUT/PUNCH** | 385 | 338 | 87.8% | 313 | **92.6%** | **81.3%** |
| **DEFLECTION/GUIDE** | 248 | 193 | 77.8% | 187 | **96.9%** | **75.4%** |
| **POWER DRIVE** | 276 | 210 | 76.1% | 195 | **92.9%** | **70.7%** |
| **SWEEP** | 243 | 211 | 86.8% | 200 | **94.8%** | **82.3%** |
| **OVERALL TOTAL** | **3786** | **3053** | **80.6%** | **2756** | 🏆 **90.3%** | 🏆 **72.8%** |
...
|---|:---:|---|
| **VERTICAL_BAT_CONFUSION** | **30** | PULL/HOOK/SLOG (26), CUT/PUNCH (4) |
| **NOT_DETECTED (MISSING_CANDIDATE)** | **23** | PULL/HOOK/SLOG (8), DEFLECTION/GUIDE (6), GLANCE/FLICK (5) |
| **SWEEP_CONFUSION** | **8** | GLANCE/FLICK (3), POWER DRIVE (2), SWEEP (1) |
| **SUBCLASS_CONFUSION** | **8** | DRIVE/DEFENCE (3), GLANCE/FLICK (3), DEFLECTION/GUIDE (1) |
| **CROSS_BAT_CONFUSION (Macro Gate)** | **8** | POWER DRIVE (8) |
| **CROSS_BAT_CONFUSION** | **5** | DRIVE/DEFENCE (3), GLANCE/FLICK (2) |
...
|---|:---:|:---:|:---:|:---:|:---:|:---:|:---:|---|
| `session_2026-07-20_12-42-16` | 62.99 | **SWEEP** | PULL/HOOK/SLOG | `SWEEP_CONFUSION` | 0.64 | 62.99 | +0.00 | *sweep shot okay* |
...
| `session_2026-07-20_12-42-16` | 429.95 | **GLANCE/FLICK** | SWEEP | `SWEEP_CONFUSION` | 0.86 | 429.95 | +0.00 | *flip shot edge* |
| `session_2026-07-20_12-42-16` | 459.47 | **GLANCE/FLICK** | SWEEP | `SWEEP_CONFUSION` | 0.40 | 459.47 | +0.00 | *flip shot okay* |
| `session_2026-07-20_12-42-16` | 557.88 | **DRIVE/DEFENCE** | SWEEP | `SWEEP_CONFUSION` | 0.87 | 557.88 | +0.00 | *straight shot good end of round* |
...
| `session_2026-07-20_12-42-16` | 880.19 | **GLANCE/FLICK** | PULL/HOOK/SLOG | `CROSS_BAT_CONFUSION` | 0.42 | 880.20 | +0.00 | *quick shot edge* |
...
| `session_2026-07-21_12-43-37` | 173.32 | **DRIVE/DEFENCE** | GLANCE/FLICK | `SUBCLASS_CONFUSION` | 0.74 | 173.32 | +0.00 | *oh back defense okay* |
| `session_2026-07-21_12-43-37` | 199.60 | **PULL/HOOK/SLOG** | GLANCE/FLICK | `VERTICAL_BAT_CONFUSION` | 0.80 | 199.60 | +0.00 | *foot shot good facing up* |
| `session_2026-07-21_12-43-37` | 207.58 | **PULL/HOOK/SLOG** | GLANCE/FLICK | `VERTICAL_BAT_CONFUSION` | 0.77 | 207.58 | +0.00 | *foot shot good* |
| `session_2026-07-21_12-43-37` | 234.02 | **DRIVE/DEFENCE** | GLANCE/FLICK | `SUBCLASS_CONFUSION` | 0.49 | 234.02 | +0.00 | *on drive okay facing up* |
| `session_2026-07-21_12-43-37` | 517.26 | **PULL/HOOK/SLOG** | GLANCE/FLICK | `VERTICAL_BAT_CONFUSION` | 0.76 | 517.26 | +0.00 | *foot shot okay* |
| `session_2026-07-21_12-43-37` | 524.97 | **PULL/HOOK/SLOG** | GLANCE/FLICK | `VERTICAL_BAT_CONFUSION` | 0.76 | 524.98 | +0.00 | *foot shot good* |
| `session_2026-07-21_12-43-37` | 572.76 | **PULL/HOOK/SLOG** | GLANCE/FLICK | `VERTICAL_BAT_CONFUSION` | 0.67 | 572.76 | +0.00 | *foot shot good* |
| `session_2026-07-21_12-43-37` | 581.22 | **PULL/HOOK/SLOG** | DRIVE/DEFENCE | `VERTICAL_BAT_CONFUSION` | 0.75 | 579.83 | -1.39 | *foot shot good facing up* |
| `session_2026-07-21_12-43-37` | 617.47 | **PULL/HOOK/SLOG** | GLANCE/FLICK | `VERTICAL_BAT_CONFUSION` | 0.66 | 616.70 | -0.77 | *hook shot good facing up* |
...
| `session_2026-07-21_12-43-37` | 955.27 | **GLANCE/FLICK** | DRIVE/DEFENCE | `SUBCLASS_CONFUSION` | 0.80 | 955.27 | +0.00 | *flip shot good* |
| `session_2026-07-21_12-43-37` | 967.40 | **GLANCE/FLICK** | ⚠️ NONE | `NOT_DETECTED (MISSING_CANDIDATE)` | 0.00 | 965.01 | -2.40 | *switch up for* |
| `session_2026-07-21_12-43-37` | 978.28 | **PULL/HOOK/SLOG** | GLANCE/FLICK | `VERTICAL_BAT_CONFUSION` | 0.74 | 978.28 | +0.00 | *foot shot good* |
| `session_2026-07-21_12-43-37` | 983.21 | **PULL/HOOK/SLOG** | DRIVE/DEFENCE | `VERTICAL_BAT_CONFUSION` | 0.83 | 983.22 | +0.00 | *foot shot good* |
...
| `session_2026-07-21_12-43-37` | 1079.79 | **GLANCE/FLICK** | DRIVE/DEFENCE | `SUBCLASS_CONFUSION` | 0.83 | 1079.79 | +0.00 | *flick shot good facing up* |
| `session_2026-07-21_12-43-37` | 1087.13 | **DRIVE/DEFENCE** | PULL/HOOK/SLOG | `CROSS_BAT_CONFUSION` | 0.93 | 1087.13 | +0.00 | *on drive okay* |
...
| `session_2026-07-24_12-52-29` | 91.96 | **DEFLECTION/GUIDE** | DRIVE/DEFENCE | `SUBCLASS_CONFUSION` | 0.68 | 91.14 | -0.82 | *guide or facing up* |
| `session_2026-07-24_12-52-29` | 91.14 | **CUT/PUNCH** | DRIVE/DEFENCE | `VERTICAL_BAT_CONFUSION` | 0.68 | 91.14 | +0.00 | *cut shot okay facing up* |
| `session_2026-07-24_12-52-29` | 152.92 | **CUT/PUNCH** | DRIVE/DEFENCE | `VERTICAL_BAT_CONFUSION` | 0.74 | 152.92 | +0.00 | *cut shot okay* |
| `session_2026-07-24_12-52-29` | 162.85 | **CUT/PUNCH** | DEFLECTION/GUIDE | `VERTICAL_BAT_CONFUSION` | 0.56 | 162.85 | +0.00 | *cut shot okay* |
...
| `session_2026-07-24_12-52-29` | 477.52 | **CUT/PUNCH** | DRIVE/DEFENCE | `VERTICAL_BAT_CONFUSION` | 0.66 | 476.79 | -0.73 | *cut shot four facing up guide good* |
| `session_2026-07-24_12-52-29` | 521.41 | **DRIVE/DEFENCE** | CUT/PUNCH | `CROSS_BAT_CONFUSION` | 0.55 | 520.20 | -1.21 | *back foot punch okay facing up* |
...
| `session_2026-07-24_12-52-29` | 566.91 | **DRIVE/DEFENCE** | CUT/PUNCH | `CROSS_BAT_CONFUSION` | 0.87 | 566.91 | +0.00 | *back foot punch okay* |
...
| `session_2026-07-25_15-16-32` | 82.82 | **PULL/HOOK/SLOG** | POWER DRIVE | `VERTICAL_BAT_CONFUSION` | 0.79 | 82.82 | +0.00 | *slog okay* |
| `session_2026-07-25_15-16-32` | 92.46 | **PULL/HOOK/SLOG** | POWER DRIVE | `VERTICAL_BAT_CONFUSION` | 0.50 | 92.46 | +0.00 | *slog four* |
| `session_2026-07-25_15-16-32` | 109.58 | **PULL/HOOK/SLOG** | POWER DRIVE | `VERTICAL_BAT_CONFUSION` | 0.51 | 109.58 | +0.00 | *slog good* |
| `session_2026-07-25_15-16-32` | 119.11 | **PULL/HOOK/SLOG** | POWER DRIVE | `VERTICAL_BAT_CONFUSION` | 0.59 | 119.11 | +0.00 | *slog edge* |
| `session_2026-07-25_15-16-32` | 150.11 | **PULL/HOOK/SLOG** | POWER DRIVE | `VERTICAL_BAT_CONFUSION` | 0.48 | 150.11 | +0.00 | *slog edge* |
| `session_2026-07-25_15-16-32` | 186.74 | **POWER DRIVE** | PULL/HOOK/SLOG | `CROSS_BAT_CONFUSION (Macro Gate)` | 0.83 | 186.74 | +0.00 | *power drive okay* |
| `session_2026-07-25_15-16-32` | 203.06 | **POWER DRIVE** | PULL/HOOK/SLOG | `CROSS_BAT_CONFUSION (Macro Gate)` | 0.64 | 203.06 | +0.00 | *power drive okay* |
| `session_2026-07-25_15-16-32` | 211.69 | **PULL/HOOK/SLOG** | POWER DRIVE | `VERTICAL_BAT_CONFUSION` | 0.44 | 211.69 | +0.00 | *slog good* |
| `session_2026-07-25_15-16-32` | 226.76 | **POWER DRIVE** | PULL/HOOK/SLOG | `CROSS_BAT_CONFUSION (Macro Gate)` | 0.72 | 226.76 | +0.00 | *power drive okay* |
| `session_2026-07-25_15-16-32` | 236.32 | **POWER DRIVE** | PULL/HOOK/SLOG | `CROSS_BAT_CONFUSION (Macro Gate)` | 0.80 | 236.32 | +0.00 | *power drive okay* |
| `session_2026-07-25_15-16-32` | 690.11 | **PULL/HOOK/SLOG** | POWER DRIVE | `VERTICAL_BAT_CONFUSION` | 0.58 | 690.11 | +0.00 | *slog good* |
| `session_2026-07-25_15-16-32` | 711.04 | **POWER DRIVE** | PULL/HOOK/SLOG | `CROSS_BAT_CONFUSION (Macro Gate)` | 0.52 | 711.04 | +0.00 | *power drive 4* |
...
| `session_2026-07-25_15-16-32` | 735.36 | **POWER DRIVE** | PULL/HOOK/SLOG | `CROSS_BAT_CONFUSION (Macro Gate)` | 0.67 | 735.37 | +0.00 | *power drive 4* |
| `session_2026-07-25_15-16-32` | 744.79 | **PULL/HOOK/SLOG** | POWER DRIVE | `VERTICAL_BAT_CONFUSION` | 0.41 | 744.79 | +0.00 | *slog good* |
| `session_2026-07-25_15-16-32` | 751.12 | **POWER DRIVE** | PULL/HOOK/SLOG | `CROSS_BAT_CONFUSION (Macro Gate)` | 0.81 | 751.12 | +0.00 | *power drive okay* |
| `session_2026-07-25_15-16-32` | 761.25 | **POWER DRIVE** | SWEEP | `SWEEP_CONFUSION` | 0.69 | 761.26 | +0.00 | *power drive 4* |
| `session_2026-07-25_15-16-32` | 782.31 | **POWER DRIVE** | SWEEP | `SWEEP_CONFUSION` | 0.65 | 782.31 | +0.00 | *power drive pull* |
| `session_2026-07-25_15-16-32` | 809.14 | **PULL/HOOK/SLOG** | POWER DRIVE | `VERTICAL_BAT_CONFUSION` | 0.74 | 809.14 | +0.00 | *slog good* |
| `session_2026-07-25_15-16-32` | 819.15 | **PULL/HOOK/SLOG** | POWER DRIVE | `VERTICAL_BAT_CONFUSION` | 0.85 | 819.15 | +0.00 | *slog good* |
| `session_2026-07-25_15-16-32` | 844.40 | **PULL/HOOK/SLOG** | POWER DRIVE | `VERTICAL_BAT_CONFUSION` | 0.75 | 844.40 | +0.00 | *slog good* |
| `session_2026-07-25_15-16-32` | 857.54 | **PULL/HOOK/SLOG** | POWER DRIVE | `VERTICAL_BAT_CONFUSION` | 0.60 | 857.54 | +0.00 | *slog okay* |
| `session_2026-07-25_15-16-32` | 878.90 | **PULL/HOOK/SLOG** | POWER DRIVE | `VERTICAL_BAT_CONFUSION` | 0.54 | 878.90 | +0.00 | *slog good in the ground* |
| `session_2026-07-25_15-16-32` | 1043.07 | **POWER DRIVE** | PULL/HOOK/SLOG | `CROSS_BAT_CONFUSION (Macro Gate)` | 0.72 | 1043.07 | +0.00 | *power drive okay facing up* |
| `session_2026-07-25_15-16-32` | 1052.24 | **GLANCE/FLICK** | PULL/HOOK/SLOG | `CROSS_BAT_CONFUSION` | 0.79 | 1052.24 | +0.00 | *flick shot okay* |
| `session_2026-07-25_15-16-32` | 1061.78 | **PULL/HOOK/SLOG** | POWER DRIVE | `VERTICAL_BAT_CONFUSION` | 0.59 | 1061.78 | +0.00 | *slog okay facing up* |
| `session_2026-07-25_15-16-32` | 1092.55 | **PULL/HOOK/SLOG** | POWER DRIVE | `VERTICAL_BAT_CONFUSION` | 0.71 | 1092.55 | +0.00 | *slog good* |
| `session_2026-07-25_15-16-32` | 1101.77 | **GLANCE/FLICK** | POWER DRIVE | `SUBCLASS_CONFUSION` | 0.41 | 1101.77 | +0.00 | *flick shot good* |
| `session_2026-07-25_15-16-32` | 1109.60 | **PULL/HOOK/SLOG** | SWEEP | `SWEEP_CONFUSION` | 0.35 | 1109.60 | +0.00 | *slog good* |
| `session_2026-07-25_15-16-32` | 1137.55 | **POWER DRIVE** | DRIVE/DEFENCE | `SUBCLASS_CONFUSION` | 0.35 | 1137.56 | +0.00 | *power drive terrible four facing up* |
| `session_2026-07-25_15-16-32` | 1162.31 | **PULL/HOOK/SLOG** | POWER DRIVE | `VERTICAL_BAT_CONFUSION` | 0.82 | 1162.31 | +0.00 | *slog okay* |
| `session_2026-07-25_15-16-32` | 1179.12 | **PULL/HOOK/SLOG** | POWER DRIVE | `VERTICAL_BAT_CONFUSION` | 0.90 | 1179.12 | +0.00 | *slog good* |
